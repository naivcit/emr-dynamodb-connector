...
final class DynamoDbHive4Shims implements DynamoDbHiveShims {

  private static final String HIVE_4_VERSION = "4.0.0";
  ...
  public SerDeParametersShim getSerDeParametersShim(Configuration configuration,
    ...
    return new Hive4SerDeParametersShim(configuration, properties, serDeName);
  }
